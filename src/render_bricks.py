...
def render_bricks(
    ...
    # # 微调（弧度）
    # cam.rotation_euler = (
    #     rx + math.radians(0),   # 再俯视 5°
    #     ry,
    #     rz + math.radians(-20),  # 水平偏 10°
    # )
        # ===== 在这里加：手动控制相机 =====
    # import math
    # cam = bpy.context.scene.camera

    # cam.location = (2.0, -3.0, 1.5)   # 相机位置
    # cam.rotation_euler = (
    #     math.radians(60),   # X：俯仰
    #     0.0,                # Y
    #     math.radians(30),   # Z：偏航
    # )

    # # 视场角（如果你不想受 square_image 影响，可以放这里）
...
def main():
    ...
    parser.add_argument('--in_file', default="/mnt/data/yanfeng/n_project/brick_gen/BrickAnything/src/mesh2brick_v2/brickmodel/knife/cpp/32/brick.ldr" ,type=str, help='Path to LDR file')
    parser.add_argument('--out_file', default="/mnt/data/yanfeng/n_project/brick_gen/BrickAnything/src/mesh2brick_v2/brickmodel/knife/cpp/32/render.png" ,type=str, help='Path to output image file')
