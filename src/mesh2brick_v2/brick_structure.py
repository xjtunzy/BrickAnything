...
import numpy as np
#mesh2brick_v2.
from mesh2brick_v2.brick_library import (brick_library,
                           dimensions_to_brick_id, brick_id_to_dimensions,
                           brick_id_to_part_id, part_id_to_brick_id)
#from stability_analysis import stability_score, StabilityConfig, connectivity_score
...
class Brick:
    ...
    @property
    def slice(self) -> tuple[slice, slice, int]:
    ...
    def to_ldr(self, base_height: float = 0,color = 68) -> str:
