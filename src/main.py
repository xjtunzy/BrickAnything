...
from BrickAnything.models.brickanything import BrickAnything
...
if __name__ == "__main__":
    ...
    ckpt_path = "/mnt/data/yanfeng/n_project/brick_gen/BrickAnything/gpt_output/training_trial_13_00-31-17/checkpoint_5000.pth"
    ...
    with accelerator.autocast():
        for curr_iter, batch_data_label in enumerate(dataloader):
            ...
            for batch_id in range(batch_size):
                ...
                render_bricks(ldr_save_path,photo_save_path)
                print(f"{ldr_save_path} Over!!")
    end_time = time.time()
