...
import numpy as np
import torch
# from meshanything_train.models.helper import load_config
...
def load_model(ckpt_path="src/brickanything_train/miche/checkpoints/aligned_shape_latents/shapevae-256.ckpt"):
    model_config = OmegaConf.load("src/brickanything_train/miche/configs/aligned_shape_latents/shapevae-256.yaml")
